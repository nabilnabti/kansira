  ...
  return (
    <div className="max-w-lg mx-auto pb-28 md:max-w-none md:pb-8 px-4">
      ...
      <motion.div
        ...
        className="relative overflow-hidden bg-gradient-to-br from-[#FF6B00] via-[#F4A100] to-[#FF6B00] rounded-3xl p-8 md:p-10 text-white text-center mb-8 shadow-xl"
      >
        <motion.div
          animate={{ rotate: 360 }}
        ...
        <motion.div
          ...
          className="absolute -bottom-12 -left-12 opacity-5"
        >
          <Sparkles size={160} />
        </motion.div>
        ...
        <p className="text-sm md:text-base opacity-90 leading-relaxed max-w-md mx-auto">
          Débloquez l'expérience complète et maîtrisez les langues africaines sans limites.
        </p>
      </motion.div>

      {/* Desktop: 2 columns — Benefits left, Pricing + comparison right */}
      <div className="md:grid md:grid-cols-2 md:gap-8">
        {/* Benefits */}
        <div className="space-y-3 mb-8 md:mb-0">
          <h2 className="hidden md:block text-lg font-bold text-[#131516] mb-4">Avantages Premium</h2>
          {benefits.map((b, i) => (
            <motion.div
              key={i}
        ...
        {/* Right column: Pricing + Feature comparison */}
        <div>
          {/* Pricing card */}
          <motion.div
            ...
            className="bg-white rounded-3xl p-6 shadow-lg border-2 border-[#FF6B00] mb-6 relative overflow-hidden"
          >
            ...
            <motion.button
              ...
              className="w-full h-14 bg-[#FF6B00] text-white font-bold text-base rounded-2xl shadow-lg shadow-[#FF6B00]/30 active:bg-[#e55f00] transition-colors cursor-pointer"
            >
